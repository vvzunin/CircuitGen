...
const MainPage = () => {
	...
	const [resyn2, setResyn2] = React.useState(false);
	const [balance, setBalance] = React.useState(false);
	const [bench, setBench] = React.useState(false);
	const [firrtl, setFirrtl] = React.useState(false);
			...
			<div className="content__left">
				...
				<div className="content pb75">
					...
					<div className="content__flags">
						<div className='content__flags-name'>Использовать resyn2</div><ToggleSwitchFilter isChecked={resyn2} changeParentState={(use) => setResyn2(use)} />
						<div className='content__flags-name'>Использовать balance</div><ToggleSwitchFilter isChecked={balance} changeParentState={(use) => setBalance(use)} />
						<div className='content__flags-name'>Сгенерировать bench</div><ToggleSwitchFilter isChecked={bench} changeParentState={(use) => setBench(use)} />
						<div className='content__flags-name'>Сгенерировать firrtl</div><ToggleSwitchFilter isChecked={firrtl} changeParentState={(use) => setFirrtl(use)} />
					</div>
